    ...
    async execute() {
        ...
        try {
            ...
            try {
                ...
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'No valid Instagram credentials found. Please configure either Instagram Access Token API or Instagram OAuth2 API credentials.');
            }
        }
            ...
            try {
                if (resource === 'message') {
                    if (operation === 'sendText') {
                        ...
                        const responseData = await GenericFunctions_1.instagramApiRequest.call(this, 'POST', '/me/messages', body, {}, { useAuthHeader: true });
                        returnData.push({ json: responseData, pairedItem: { item: i } });
                    }
                    ...
                    if (operation === 'createSinglePost') {
                        ...
                        const creationId = this.getNodeParameter('creationId', i);
                        const responseData = await GenericFunctions_1.instagramApiRequest.call(this, 'GET', `/${creationId}`, {}, { fields: 'status_code' }, { useAuthHeader: true });
                        returnData.push({ json: responseData, pairedItem: { item: i } });
                    }
                }
                    ...
                    if (operation === 'reply') {
                        ...
                        const responseData = await GenericFunctions_1.instagramApiRequest.call(this, 'POST', `/${commentId}/replies`, {
                            message: message,
                        });
                        returnData.push({ json: responseData, pairedItem: { item: i } });
                    }
                        ...
                        const commentId = this.getNodeParameter('commentId', i);
                        const hide = this.getNodeParameter('hide', i);
                        const responseData = await GenericFunctions_1.instagramApiRequest.call(this, 'POST', `/${commentId}`, {}, { hide: hide.toString() });
                        returnData.push({ json: responseData, pairedItem: { item: i } });
                    }
                    ...
                    const tokenOperation = this.getNodeParameter('operation', i);
                    if (tokenOperation === 'checkStatus') {
                        const { getTokenStatus } = await Promise.resolve().then(() => __importStar(require('./GenericFunctions')));
                        const response = await getTokenStatus(this, 'default');
                        returnData.push({ json: response, pairedItem: { item: i } });
                    }
                    else if (tokenOperation === 'refreshToken') {
                        const { forceRefreshToken } = await Promise.resolve().then(() => __importStar(require('./GenericFunctions')));
                        const response = await forceRefreshToken(this, 'default');
                        returnData.push({ json: response, pairedItem: { item: i } });
                    }
                    else if (tokenOperation === 'clearCache') {
                        const { clearTokenCache } = await Promise.resolve().then(() => __importStar(require('./GenericFunctions')));
                        ...
                        const { getAccessTokenHybrid } = await Promise.resolve().then(() => __importStar(require('./GenericFunctions')));
